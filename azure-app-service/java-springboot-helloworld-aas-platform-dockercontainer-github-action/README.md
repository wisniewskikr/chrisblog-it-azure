...
* How to deploy **Java Spring Boot** application using **Azure App Services Deployment Center** type **Docker Container - Docker Hub** where source code is in **Github** and is managed by **Action**. It means that user just deploys code to Github and there defined Action will update Docker Hub and deploy Docker Image in Azure.
...
![My Image](readme-images/create-deployment-center-09.png)

![My Image](readme-images/create-deployment-center-10.png)

![My Image](readme-images/create-deployment-center-11.png)

![My Image](readme-images/create-deployment-center-12.png)

![My Image](readme-images/create-deployment-center-13.png)

![My Image](readme-images/create-deployment-center-14.png)

![My Image](readme-images/create-deployment-center-15.png)

![My Image](readme-images/create-deployment-center-16.png)
